    ...
    useEffect(() => {
        function handleScroll() {
            ...
            const distanceFromBottom =
                (fullHeight - (scrollTop + windowHeight) + 15) * -0.3
                ...
                <div className="flex row gap20">
                    <div>
                        ...
                        <p className="hidden-xs">
                            Lorem ipsum dolor sit amet consectetur, adipisicing
                            elit. Aliquam labore at ad numquam animi nam harum.
                            Laboriosam, ex. Aperiam, beatae.
                        </p>
                        ...
                        <p className="hidden-xs">
                            ...
                            <br />
                            <a
                                href="mailto:fakeJohn@example.com"
                                className="link"
                            >
                                fakeJohn@example.com
                            </a>
                        </p>
                    </div>
                    <div className="hidden-xs">
                        ...
                        <p>
                            Our Phone
                            <br />
                            <a href="tel:16288000000" className="link">
                                +1(628)800-00-00
                            </a>
                        </p>
                        <p>
                            San Francisco, CA 2 Embarcadero Center, 8 floor,
                            94111
                        </p>
                    </div>
                    <div>
